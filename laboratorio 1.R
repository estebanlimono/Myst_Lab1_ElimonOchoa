...
#Para analizar este portafolio de activos los escogí en base a empresas que hayan tenido buenos resultados financieros.
#La teoría de inversión pasiva es buena y el portafolio de Markowitz te ayuda a elegir las mejores ponderaciones según tu estilo de inversión.
#Al generar 10,000 portafolios aleatorios con diferentes ponderaciones se puede elegir el que te maneje mejor perfil según tu elección.
#Se debe de saber qe la teoría de portafolios de inversión moderna trabaja con datos pasados, por lo que también se deben de considerar otras variables antes de invertir.
#El portafolio de Markowitz azul te da el mayor rendimiento ante el mínimo riesgo, este se recomienda a personas que esten invirtiendo parte de su fondo de retiro.
#El portafolio amarillo te demuestra el mayor ratio sharpe o mayor esperanza del portafolio restandole la tasa libre de riesgo y dividiendolo entre la desviación del activo.
